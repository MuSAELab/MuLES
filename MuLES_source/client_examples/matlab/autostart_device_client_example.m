% MuLES AutoStart (Device) Client example
% This script shows how to initializate MuLES from the command line, to
% stream data from a given device, in this case DEVICE03, which is 
% based on Muse Headband hardware, see config.ini file in section DEVICE03\
